...
import ca.magical.unicorn.maps.EasterIsland;
...
public class EasterIslandLevel extends WindowGame {
	...
	public void init(GameContainer container, StateBasedGame game) throws SlickException {
    	...
    	this.game = game;
    	this.map = new EasterIsland(); // On charge la map 
    	
    	this.character = new Unicorn(390,575); // debug position départ licorne
    	if(Game.isMulti) {
    		this.character2 = new FatBunny(395,642); 
    	}
